...
├── app_profile.rs                       # apps/default + apps/<bundle_id> profile 加载（ASR + post_chain 组合）
├── cli/
│   ├── mod.rs                           # clap 子命令分发
