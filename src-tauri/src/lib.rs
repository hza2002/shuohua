...
fn gui_daemon_event_payload(event: &Event) -> Option<GuiDaemonEventPayload> {
    match event {
        ...
        Event::StatsChanged { dur_ms, words } => Some(GuiDaemonEventPayload {
            kind: "streamStats",
            state_label: None,
            recording_id: None,
            live_text: None,
        ...
        Event::Partial { recording_id, text } => Some(GuiDaemonEventPayload {
            kind: "liveText",
            state_label: None,
            recording_id: Some(recording_id.clone()),
            live_text: Some(text.clone()),
            duration_ms: None,
            word_count: None,
            history_record_count_delta: 0,
            latest_preview: None,
        ...
        Event::Segment { recording_id, text } => Some(GuiDaemonEventPayload {
            kind: "liveText",
            state_label: None,
            recording_id: Some(recording_id.clone()),
            live_text: Some(text.clone()),
        ...
        Event::HistoryAppended { record } => Some(GuiDaemonEventPayload {
            kind: "historyAppended",
            state_label: None,
            recording_id: Some(record.id.clone()),
            live_text: None,
            duration_ms: Some(record.duration_ms),
            word_count: Some(record.text_stats().words as u32),
            history_record_count_delta: 1,
            latest_preview: Some(format!(
                "{}: {}",
