...
impl WindowsOverlayScene {
    pub(super) fn from_model(
        ...
        Self {
            ...
            panel_width,
            frames,
            panel_color: cfg.core.background_rgb,
            panel_alpha: cfg.core.background_alpha,
            corner_radius: cfg.core.corner_radius,
            text_scale: cfg.core.text_scale,
            state_icon: state_icon_plan(model.state),
            state_label: model.state_label.clone(),
            state_color: model.state_color,
            stats,
            stats_color: cfg.core.text.secondary,
            meta,
            meta_color,
            body_color,
        }
