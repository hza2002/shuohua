    ...
    for replacement in non_macos_desktop_capabilities(PlatformKind::Windows)
        ...
        .chain([
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "WH_KEYBOARD_LL hook has passed full record-to-paste smoke in Notepad and VS Code",
                reason: "notepad_vscode_record_paste_smoke",
                next_step: Some("Validate hotkey press/release tracking across browser, terminal, IME, remote desktop, and UAC boundaries"),
            },
            CapabilityStatus {
                ...
                backend: "wh_keyboard_ll",
                status: CapabilityStatusKind::Partial,
                summary: "Low-level hook suppression has passed full record-to-paste smoke in Notepad and VS Code",
                reason: "notepad_vscode_record_paste_smoke",
                next_step: Some("Validate suppressed down/up pairing, stuck modifier prevention, browser, terminal, IME, and UAC boundaries"),
            },
            CapabilityStatus {
                id: CapabilityId::IpcTransport,
                platform: PlatformKind::Windows,
            ...
            CapabilityStatus {
                ...
                backend: "cpal_wasapi",
                status: CapabilityStatusKind::Partial,
                summary: "cpal/WASAPI input has passed real microphone full record-to-paste smoke in Notepad and VS Code",
                reason: "notepad_vscode_record_paste_smoke",
                next_step: Some(
            ...
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "Voice dispatch can write Unicode text and feed full record-to-paste smoke in Notepad and VS Code",
                reason: "notepad_vscode_record_paste_smoke",
                next_step: Some("Validate full record-to-clipboard behavior across browser, terminal, IME, and elevation boundaries"),
            },
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "SendInput Ctrl+V has passed full record-to-paste smoke in Notepad and VS Code",
                reason: "notepad_vscode_record_paste_smoke",
                next_step: Some("Validate Ctrl+V injection across browser, terminal, IME, remote desktop, and UAC/elevation boundaries"),
            },
            CapabilityStatus {
