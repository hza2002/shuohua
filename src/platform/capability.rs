    ...
    for replacement in non_macos_desktop_capabilities(PlatformKind::Windows)
        ...
        .chain([
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "WH_KEYBOARD_LL hook has passed full record-to-paste smoke across common Windows targets",
                reason: "common_targets_record_paste_smoke",
                next_step: Some("Validate hotkey press/release tracking across remote desktop, UAC/elevation, and Office/Teams-style apps"),
            },
            CapabilityStatus {
                ...
                backend: "wh_keyboard_ll",
                status: CapabilityStatusKind::Partial,
                summary: "Low-level hook suppression has passed full record-to-paste smoke across common Windows targets",
                reason: "common_targets_record_paste_smoke",
                next_step: Some("Validate suppressed down/up pairing, stuck modifier prevention, remote desktop, UAC/elevation, and Office/Teams-style apps"),
            },
            CapabilityStatus {
                id: CapabilityId::IpcTransport,
                platform: PlatformKind::Windows,
            ...
            CapabilityStatus {
                ...
                backend: "cpal_wasapi",
                status: CapabilityStatusKind::Partial,
                summary: "cpal/WASAPI input has passed real microphone full record-to-paste smoke across common Windows targets",
                reason: "common_targets_record_paste_smoke",
                next_step: Some(
            ...
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "Voice dispatch can write Unicode text and feed full record-to-paste smoke across common Windows targets",
                reason: "common_targets_record_paste_smoke",
                next_step: Some("Validate full record-to-clipboard behavior across UAC/elevation and Office/Teams-style apps"),
            },
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "SendInput Ctrl+V has passed full record-to-paste smoke across common Windows targets",
                reason: "common_targets_record_paste_smoke",
                next_step: Some("Validate Ctrl+V injection across remote desktop, UAC/elevation, and Office/Teams-style apps"),
            },
            CapabilityStatus {
                ...
                status: CapabilityStatusKind::Partial,
                summary: "Foreground window process identity can drive Windows profile route matching for a self foreground window",
                reason: "foreground_profile_route_self_window_smoke",
                next_step: Some("Validate foreground app route matching across packaged Windows apps and broader real app targets"),
            },
        ])
    {
        replace_capability(&mut capabilities, replacement);
